...
public class Program {
    public static void main(String[] args) {
        ...
        Instant d07 = Instant.parse("2023-05-29T06:20:35-03:00");
        LocalDate d08 = LocalDate.parse("29/05/2023", fmt1);
        LocalDateTime d09 = LocalDateTime.parse("29/05/2023 02:30", fmt2);
        LocalDate d10 = LocalDate.of(2023, 5, 29);
        LocalDateTime d11 = LocalDateTime.of(2023, 5, 29, 14, 41);
